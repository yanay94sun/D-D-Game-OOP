public class Rogue extends Player {
    ...
    public Rogue(int cost, int currentEnergy, int x, int y, String Name, char Tile, int HP, int AP, int DP, int EXP, int PL){
        super(x, y);
        this.cost = cost;
    ...
    public void castAbility(Enemey[] level_enemies) {
        if (this.currentEnergy >= this.cost){
            ...
            try {
                ...
                System.out.println("Error message: NOT enough energy");
            }
        }
    }
